...
',
  ...
  array (
    ...
    'product_review.front.review.confirm.description' => '下記の内容で送信してもよろしいでしょうか？
...
',
    ...
    'product_review.front.review.complete.thanks_detail' => '内容を確認後、反映させていただきます。
今しばらくお待ちくださいませ。
',
    ...
    'gmc.admin.title' => 'Google Merchant Center 連携',
    'gmc.admin.site_verification.settings' => 'サイト認証設定',
    'gmc.admin.site_verification.file' => '認証用HTMLファイル',
    'gmc.admin.gmc.settings' => 'Merchant Center連携設定',
