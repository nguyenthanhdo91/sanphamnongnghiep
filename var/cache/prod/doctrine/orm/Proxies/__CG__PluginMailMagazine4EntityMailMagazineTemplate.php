 ...
 */
class MailMagazineTemplate extends \Plugin\MailMagazine4\Entity\MailMagazineTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\MailMagazine4\\Entity\\MailMagazineTemplate' . "\0" . 'id', '' . "\0" . 'Plugin\\MailMagazine4\\Entity\\MailMagazineTemplate' . "\0" . 'subject', '' . "\0" . 'Plugin\\MailMagazine4\\Entity\\MailMagazineTemplate' . "\0" . 'body', '' . "\0" . 'Plugin\\MailMagazine4\\Entity\\MailMagazineTemplate' . "\0" . 'html_body', '' . "\0" . 'Plugin\\MailMagazine4\\Entity\\MailMagazineTemplate' . "\0" . 'create_date', '' . "\0" . 'Plugin\\MailMagazine4\\Entity\\MailMagazineTemplate' . "\0" . 'update_date'];
        }
