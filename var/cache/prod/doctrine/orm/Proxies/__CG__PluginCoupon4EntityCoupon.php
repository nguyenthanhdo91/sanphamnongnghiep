...
namespace Proxies\__CG__\Plugin\Coupon4\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Coupon extends \Plugin\Coupon4\Entity\Coupon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'id', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'coupon_cd', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'coupon_type', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'coupon_name', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'discount_type', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'coupon_use_time', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'discount_price', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'discount_rate', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'enable_flag', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'available_from_date', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'available_to_date', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'visible', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'coupon_member', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'coupon_lower_limit', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'coupon_release', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'create_date', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'update_date', '' . "\0" . 'Plugin\\Coupon4\\Entity\\Coupon' . "\0" . 'CouponDetails'];
        }
     ...
     * {@inheritDoc}
     */
    public function addCouponDetail(\Plugin\Coupon4\Entity\CouponDetail $couponDetails)
    {
     ...
     * {@inheritDoc}
     */
    public function removeCouponDetail(\Plugin\Coupon4\Entity\CouponDetail $couponDetails)
    {
