 ...
 */
class ProductReviewConfig extends \Plugin\ProductReview4\Entity\ProductReviewConfig implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ProductReview4\\Entity\\ProductReviewConfig' . "\0" . 'id', '' . "\0" . 'Plugin\\ProductReview4\\Entity\\ProductReviewConfig' . "\0" . 'review_max', '' . "\0" . 'Plugin\\ProductReview4\\Entity\\ProductReviewConfig' . "\0" . 'CsvType', '' . "\0" . 'Plugin\\ProductReview4\\Entity\\ProductReviewConfig' . "\0" . 'create_date', '' . "\0" . 'Plugin\\ProductReview4\\Entity\\ProductReviewConfig' . "\0" . 'update_date'];
        }
