...
namespace Proxies\__CG__\Plugin\Api\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class WebHook extends \Plugin\Api\Entity\WebHook implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\Api\\Entity\\WebHook' . "\0" . 'id', '' . "\0" . 'Plugin\\Api\\Entity\\WebHook' . "\0" . 'payloadUrl', '' . "\0" . 'Plugin\\Api\\Entity\\WebHook' . "\0" . 'secret', '' . "\0" . 'Plugin\\Api\\Entity\\WebHook' . "\0" . 'enabled', '' . "\0" . 'Plugin\\Api\\Entity\\WebHook' . "\0" . 'createDate', '' . "\0" . 'Plugin\\Api\\Entity\\WebHook' . "\0" . 'updateDate'];
        }
