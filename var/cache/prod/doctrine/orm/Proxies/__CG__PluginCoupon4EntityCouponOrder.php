 ...
 */
class CouponOrder extends \Plugin\Coupon4\Entity\CouponOrder implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'id', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'coupon_id', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'coupon_cd', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'coupon_name', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'user_id', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'email', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'order_id', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'pre_order_id', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'order_date', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'order_item_id', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'discount', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'visible', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'order_change_status', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'create_date', '' . "\0" . 'Plugin\\Coupon4\\Entity\\CouponOrder' . "\0" . 'update_date'];
        }
