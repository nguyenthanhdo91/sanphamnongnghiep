...
namespace Proxies\__CG__\Plugin\RelatedProduct4\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class RelatedProduct extends \Plugin\RelatedProduct4\Entity\RelatedProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\RelatedProduct4\\Entity\\RelatedProduct' . "\0" . 'id', '' . "\0" . 'Plugin\\RelatedProduct4\\Entity\\RelatedProduct' . "\0" . 'content', '' . "\0" . 'Plugin\\RelatedProduct4\\Entity\\RelatedProduct' . "\0" . 'Product', '' . "\0" . 'Plugin\\RelatedProduct4\\Entity\\RelatedProduct' . "\0" . 'ChildProduct'];
        }
