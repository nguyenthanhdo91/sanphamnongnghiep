...
// Returns the public 'Plugin\Api\Controller\Admin\WebHookController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'Api'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'WebHookController.php';

$this->services['Plugin\\Api\\Controller\\Admin\\WebHookController'] = $instance = new \Plugin\Api\Controller\Admin\WebHookController(($this->privates['Plugin\\Api\\Repository\\WebHookRepository'] ?? $this->getWebHookRepositoryService()));
