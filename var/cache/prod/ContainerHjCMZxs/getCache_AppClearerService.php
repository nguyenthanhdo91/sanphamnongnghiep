...
return $this->services['cache.app_clearer'] = new \Symfony\Component\HttpKernel\CacheClearer\Psr6CacheClearer(['cache.app' => ($this->services['cache.app'] ?? $this->load('getCache_AppService.php')), 'doctrine.app_cache_pool' => ($this->privates['doctrine.app_cache_pool'] ?? $this->getDoctrine_AppCachePoolService())]);
