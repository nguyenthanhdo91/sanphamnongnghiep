...
// Returns the public 'Plugin\ProductReview4\Controller\Admin\ProductReviewController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'ProductReview4'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'ProductReviewController.php';

$this->services['Plugin\\ProductReview4\\Controller\\Admin\\ProductReviewController'] = $instance = new \Plugin\ProductReview4\Controller\Admin\ProductReviewController(($this->privates['Eccube\\Repository\\Master\\PageMaxRepository'] ?? $this->load('getPageMaxRepositoryService.php')), ($this->privates['Plugin\\ProductReview4\\Repository\\ProductReviewRepository'] ?? $this->load('getProductReviewRepositoryService.php')), ($this->privates['Plugin\\ProductReview4\\Repository\\ProductReviewConfigRepository'] ?? $this->load('getProductReviewConfigRepositoryService.php')), ($this->privates['Eccube\\Service\\CsvExportService'] ?? $this->load('getCsvExportServiceService.php')));
