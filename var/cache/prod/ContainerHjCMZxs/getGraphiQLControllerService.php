...
// Returns the public 'Plugin\Api\Controller\Admin\GraphiQLController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'Api'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'GraphiQLController.php';

$this->services['Plugin\\Api\\Controller\\Admin\\GraphiQLController'] = $instance = new \Plugin\Api\Controller\Admin\GraphiQLController(($this->services['kernel'] ?? $this->get('kernel', 1)), ($this->privates['Plugin\\Api\\GraphQL\\Schema'] ?? $this->load('getSchemaService.php')));
