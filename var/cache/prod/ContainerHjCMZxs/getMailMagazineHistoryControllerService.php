...
// Returns the public 'Plugin\MailMagazine4\Controller\MailMagazineHistoryController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'MailMagazine4'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'MailMagazineHistoryController.php';

$this->services['Plugin\\MailMagazine4\\Controller\\MailMagazineHistoryController'] = $instance = new \Plugin\MailMagazine4\Controller\MailMagazineHistoryController(($this->privates['Plugin\\MailMagazine4\\Service\\MailMagazineService'] ?? $this->load('getMailMagazineServiceService.php')), ($this->privates['Plugin\\MailMagazine4\\Repository\\MailMagazineSendHistoryRepository'] ?? $this->load('getMailMagazineSendHistoryRepositoryService.php')), ($this->privates['Eccube\\Repository\\Master\\PageMaxRepository'] ?? $this->load('getPageMaxRepositoryService.php')));
