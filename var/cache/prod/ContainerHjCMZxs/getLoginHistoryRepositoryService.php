...
return $this->privates['Eccube\\Repository\\LoginHistoryRepository'] = new \Eccube\Repository\LoginHistoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->privates['Eccube\\Doctrine\\Query\\Queries'] ?? $this->getQueriesService()));
