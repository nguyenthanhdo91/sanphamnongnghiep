...
$this->services['Eccube\\Controller\\ForgotController'] = $instance = new \Eccube\Controller\ForgotController(($this->services['validator'] ?? $this->load('getValidatorService.php')), ($this->privates['Eccube\\Service\\MailService'] ?? $this->load('getMailServiceService.php')), ($this->privates['Eccube\\Repository\\CustomerRepository'] ?? $this->load('getCustomerRepositoryService.php')), ($this->privates['security.encoder_factory.generic'] ?? $this->getSecurity_EncoderFactory_GenericService()));
