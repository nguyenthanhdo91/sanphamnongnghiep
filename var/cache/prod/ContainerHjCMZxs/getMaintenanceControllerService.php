...
$this->services['Eccube\\Controller\\Admin\\Content\\MaintenanceController'] = $instance = new \Eccube\Controller\Admin\Content\MaintenanceController(($this->services['Eccube\\Service\\SystemService'] ?? $this->load('getSystemServiceService.php')));
